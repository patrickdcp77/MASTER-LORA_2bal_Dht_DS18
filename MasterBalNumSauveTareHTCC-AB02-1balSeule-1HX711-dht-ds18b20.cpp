...
static void prepareTxFrame( uint8_t port )
{
  ...
  */
  ...
  //===========================================================================
  // ÉTAPE 1: ACTIVATION DE L'ALIMENTATION DES CAPTEURS
  //===========================================================================
  // Vext = broche d'alimentation contrôlable du HTCC-AB02
  // LOW = alimentation ACTIVÉE (logique inversée)
  // HIGH = alimentation COUPÉE
  pinMode(Vext, OUTPUT);
  digitalWrite(Vext, LOW);    // Active l'alimentation pour HX711, DHT22, DS18B20
  ...
  */
  ...
  //===========================================================================
  // ÉTAPE 7: DÉSACTIVATION DE L'ALIMENTATION DES CAPTEURS
  //===========================================================================
  // Pour économiser l'énergie, on coupe l'alimentation des capteurs
  // HIGH = alimentation COUPÉE (logique inversée sur Vext)
...
void setup() {
    ...
    //===========================================================================
    // ÉTAPE 3: ACTIVATION DE L'ALIMENTATION DES CAPTEURS (Vext)
    //===========================================================================
    // Vext = pin d'alimentation commutable du HTCC-AB02
    // Permet de couper l'alimentation des capteurs externes pour économiser l'énergie
    // LOW = ACTIVÉ, HIGH = COUPÉ (logique inversée)
    pinMode(Vext, OUTPUT);
    digitalWrite(Vext, LOW);  // Active l'alimentation
    delay(500);               // Attend 500ms que les capteurs s'alimentent
    
    //===========================================================================
    // ÉTAPE 4: INITIALISATION DE L'EEPROM ET GESTION DE LA TARE
    //===========================================================================
