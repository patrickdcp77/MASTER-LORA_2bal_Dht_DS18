...
//lora-31
uint8_t devEui[] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x07, 0x26, 0x14 };
uint8_t appKey[] = { 0xB4, 0x0F, 0xA5, 0x5E, 0x86, 0x8E, 0x60, 0xD0, 0x8B, 0xCB, 0x93, 0xE8, 0xEB, 0x8C, 0xE2, 0x76 };
...
uint32_t appTxDutyCycle = 10000;//////////////à modifier pour changer cycle d'envoi à TTN  900 000 = 15mn
